...
- iOS（木南、船越）
  - iOS15周り
    - iOS 15.3.1 リリースされた
      - 動作確認済
    - iOS 15.4Beta3がリリースされた
      - 全体共有はなし
    - iOS 14は継続して報告を行う
    - 調査・対応依頼があればそちらも
- Android（外山、福岡）
  - Android 13 preview1がリリースされた
    - まずは情報収集からはじめる
    - 端末購入は今後必要になってから
  - Android12 L情報収集中
  - 細かいタスクを消化中
...
- admobメディエーション
  - v20.5.0 対応中
    ...
    - 主にテスト周りの修正になりそう
      - htmlOnPlayingでonClickが呼ばれない事象の調査
- 世界遺産ビューア
  - 残り2つViewの置き換えくらいの進捗
...
#### 問い合わせ対応
- 27566 掲載可能な動画フォーマット　回答済
- リワード動画２個連続再生される。詳細求めている。
...
- レビュー
- Cocos2dxのレポジトリアーカイブ済
- 採用
  - 1名 内定承諾、調整
  - スカウト継続
- Herokuの管理（Githubレビュアーアサイン通知関連）
- タスク、スケジュール調整
- マネージャ業務周り
  - 会社支給PCのセキュリティ強化の準備
